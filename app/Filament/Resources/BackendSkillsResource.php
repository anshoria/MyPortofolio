...
use App\Filament\Resources\BackendSkillsResource\Pages;
...
class BackendSkillsResource extends Resource
{
    protected static ?string $model = BackendSkills::class;

    protected static ?string $navigationIcon = 'heroicon-o-server';

    protected static ?string $navigationGroup = 'Skills Management';

    protected static ?string $navigationLabel = 'Backend Skills';
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Skill Information')
                    ->description('Add or edit backend skill details')
                    ->schema([
    ...
    {
        return [
            'index' => Pages\ListBackendSkills::route('/'),
            'create' => Pages\CreateBackendSkills::route('/create'),
            'edit' => Pages\EditBackendSkills::route('/{record}/edit'),
        ];
    }
